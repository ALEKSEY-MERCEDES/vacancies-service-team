...
from infrastructure.db.models import User, Candidate, Vacancy, Company, Reaction
from bot.keyboards.candidate_saved import candidate_saved_kb, candidate_saved_detail_kb
